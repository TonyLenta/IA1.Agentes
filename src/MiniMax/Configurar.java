...
public class Configurar extends javax.swing.JFrame {
 ...
 /*Predeterminado.*/
    ...
    public Configurar() {
        ...
        /*Iniciamos variables.*/
        fichas1[0] = new ImageIcon(getClass().getResource("/MiniMax/images/circulo4.png"));
        fichas1[1] = new ImageIcon(getClass().getResource("/MiniMax/images/cruz.png"));

        fichas2[0] = new ImageIcon(getClass().getResource("/MiniMax/images/radio1.png"));
        fichas2[1] = new ImageIcon(getClass().getResource("/MiniMax/images/radio2.png"));

        fichas3[0] = new ImageIcon(getClass().getResource("/MiniMax/images/disco1.png"));
        fichas3[1] = new ImageIcon(getClass().getResource("/MiniMax/images/disco2.png"));

        fichas4[0] = new ImageIcon(getClass().getResource("/MiniMax/images/cielo1.png"));
        fichas4[1] = new ImageIcon(getClass().getResource("/MiniMax/images/cielo2.png"));
    ...
    private void initComponents() {
        ...
        lblFicha1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/circulo3.png"))); // NOI18N

        lblFicha2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/cruz.png"))); // NOI18N

        lblInstrucciones.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/rating_star.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/icon_arrow.gif"))); // NOI18N
