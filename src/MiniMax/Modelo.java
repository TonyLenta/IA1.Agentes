...
public class Modelo extends javax.swing.JFrame {
    ...
    /*Juego del MiniMax donde se aplicar� este modelo.*/
    ...
    /*M�todo que env�a los datos ( modelo ) al MiniMax.*/
    public void enviarModelo() {
        MiniMax.recojerModelo();
    }
    ...
    private void initComponents() {
        ...
        setIconImage(new ImageIcon(this.getClass().getResource("/MiniMax/images/gdm.png")).getImage());
        setLocationByPlatform(true);
        setUndecorated(true);

        opcionUno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/rating_star.png"))); // NOI18N
        ...
        img1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/pvsp.png"))); // NOI18N

        img2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/pvspc.png"))); // NOI18N

        img3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/persona.png"))); // NOI18N

        opcionDos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/rating_star.png"))); // NOI18N
        ...
        btnAceptar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/checkin.png"))); // NOI18N
        ...
        btnCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/MiniMax/images/cancelar.png"))); // NOI18N
