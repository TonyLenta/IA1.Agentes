...
public class AddNew3 {
    ...
    */
	...
	try {
		...
		rma = mainContainer.createNewAgent("Ejemplo", "protocolos.query.Viajante", new Object[0]);
		rma.start();
                
                rma2 = mainContainer.createNewAgent("Lavacolla", "protocolos.query.Aeropuerto", new Object[0]);
		rma2.start();
